<header>
    ...
    <div class="menu_container">
        ...
        <?php
            ...
            if ($role == 1) {
                echo "<a class='menu_item' href='../admin/groom.php'> Панель администратора </a> |
                        <a class='menu_item' href='../index.php'> Главная </a> |
                        <form method='POST' action='../php/logout.php' class='header_form'>
                            <input type='submit' class='logout' value='Выход'>
                        </form>";
            }
            else if ($role == 2) {
                echo "<a class='menu_item' href='../user.php'> Личный кабинет </a> |
                        <a class='menu_item' href='../index.php'> Главная </a> |
                        <form method='POST' action='../php/logout.php' class='header_form'>
                            <input type='submit' class='logout' value='Выход'>
                        </form>";
                ...
                echo "<a class='menu_item' href='../index.php#reg'> Регистрация </a> |
                <a class='menu_item' href='../index.php#auth'> Войти </a>";
            }
